...
const NoteForm = () => {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-slate-700 text-white" : "bg-gray-100"} min-h-screen flex items-center justify-center`}>
      <div className={`${theme === "dark" ? "bg-zinc-500 text-white" : "bg-gray-300"} p-6 rounded-lg shadow-xl w-full max-w-lg`}  >
